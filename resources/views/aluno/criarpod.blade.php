...
@section('content')
    ...
    <div class="flex justify-center">
        <div class="rounded-lg shadow-lg bg-white text-center max-w-xl">
            ...
            <form action="{{route('rpodpage.criarRpods')}}" method="POST" enctype="multipart/form-data" class="p-9">
                @csrf
                
                <div class="form-group p-3 mb-3">
                    <label for="mes" class="form-label inline-block mb-2">Mês:   </label> 
                    <input type="number" class="form-control w-full px-2 py-1 font-normal bg-white border border-solid border-gray-300 rounded m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600" id="mes" name="mes">
                </div>
                <div class="form-group mb-3">
                    <label for="horas_mes" class="form-label inline-block mb-2">Horas:   </label> 
                    <input type="number" class="form-control w-full px-2 py-1 font-normal bg-white border border-solid border-gray-300 rounded m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600" id="horas_mes" name="horas_mes" >
                </div>
