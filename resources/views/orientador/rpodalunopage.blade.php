    ...
    @foreach ($rpods as $r)
        ...
        <div class="flex justify-center">
            ...
            <div class="rounded-lg shadow-lg bg-white text-left w-5/6">
                ...
                <div class="p-6 pt-0 ">
                    <h3 class="text-gray-900 text-xl leading-tight font-medium mb-2">Entrega do RPOD do mês
                        {{ $r['mes'] }} - {{ $r['horas_mes'] }}h</h3>
                </div>
                ...
                <div class="pb-3 pr-3 flex justify-end ">
                    ...
                    <a href="{{ route('orientador.rpodpage.download', $r->id) }}">
                        <button class="inline-block rounded-full bg-orange-600 text-white hover:bg-orange-500 w-7 h-7">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-download"
                                width="28" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
