                ...
                >
                    <div class="flex items-center space-x-4">
                        <svg class="flex inline-block h-8 w-8 text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                          ...
                          <h1 class="text-xl font-medium text-gray-800 ">Deseja realmente apagar o Registro  ?</h1>
                        ...
                        <div class="flex justify-end mt-6">
                            ...
                            <a class="justify-items-center flex flex-col " href="{{ route('registro.delete', $r->id) }}" >
