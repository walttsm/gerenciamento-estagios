            ...
            <div class="grid grid-cols-10 p-6 rounded-lg shadow-lg bg-white w-5/6 relative">
                ...
                <div class="top-0 right-1.5 absolute pr-7">
                    <a href="{{ route('documentos.edit', $doc->id) }}">
                        <button class="bg-orange-600 rounded-sm bg-silverblue text-white w-5 h-5 mr-3"
                            data-modal-toggle="popup-modal">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-pencil"
                                width="20" height="15" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="text-right col-end-11 mt-4">
                    <a href="{{ route('coordenador.documentos.download', $doc->id) }}">
                        <button type="button"
                            class="px-6 py-2.5 bg-orange-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-orange-700 hover:shadow-lg focus:bg-orange-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-800 active:shadow-lg transition duration-150 ease-in-out">
