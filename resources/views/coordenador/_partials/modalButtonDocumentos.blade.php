<div class="flex justify-end">
    <div class="top-0 right-0 absolute pr-2 pl-2" x-data="{ modelOpen: false }">
        <button @click="modelOpen =!modelOpen" class="bg-orange-600 rounded-sm bg-silverblue text-white w-5 h-5">
            ...
            <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                ...
                >
                    <div class="flex items-center space-x-4">
                        <svg class="flex inline-block h-8 w-8 text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 10.5v3.75m-9.303 3.376C1.83 19.126 2.914 21 4.645 21h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 4.88c-.866-1.501-3.032-1.501-3.898 0L2.697 17.626zM12 17.25h.007v.008H12v-.008z" />
                          </svg>

                          <h1 class="text-xl font-medium text-gray-800 ">Deseja realmente apagar o Documento  ?</h1>
                
                    </div>
    
                        <div class="flex justify-end mt-6">
                            <button @click="modelOpen = false" class="justify-center mr-2 text-center px-6 py-2.5 
                            ...
                            <a class="justify-items-center flex flex-col " href="{{ route('documentos.delete', $doc->id) }}" >

                                <button class="justify-center text-center px-6 py-2.5 
